...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =0{Never pushed} =1{Pushed once} other{Pushed {count} times}}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{choice, select, fr {Français} en {English} other {}}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{choice, select, light {Light} dark {Dark} system {System} other {}}'**
